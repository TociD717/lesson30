...
function isValidEmail(email) {
  let regularMail = /^[a-zA-Z0-9._]+@\w+\.[a-z]{2,3}$/
...
console.log(isValidEmail('carpenterbrut@gmail.com'))
...
function isValidUrl(url) {
  let regularUrl = /^(https:\/\/)(www\.)?[a-zA-Z0-9-]+\.[a-zA-Z]{2,}$/
  if (regularUrl.test(url)) {
    return true
  } else {
    return false
  }
...
console.log(isValidUrl('ithillel.com'))
console.log(isValidUrl('www.ithillel.com'))
console.log(isValidUrl('https://www.ithillel.com'))
console.log(isValidUrl('ithillel'))
